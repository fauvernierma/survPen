...
- the penalized log-likelihood: `r mod.pen$ll`
...
- llold =  former value of the penalized log-likelihood
- ll =  current value of the penalized log-likelihood
- ll-llold =  difference of the two values above
