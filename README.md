...
#> (Intercept)    0.033          0.022          0.047
#> 
#> log-likelihood = -2042.4, penalized log-likelihood = -2045.6
#> Number of parameters = 25, effective degrees of freedom = 10.534
#> LAML = 2055.6 
#>  
...
#> 
#>   Mathieu Fauvernier, Laurent Remontet, Zoé Uhry, Nadine Bossard and
#>   Laurent Roche (2019). survPen: an R package for hazard and excess
#>   hazard modelling with multidimensional penalized splines. Journal of
#>   Open Source Software, 4(40), 1434. doi: 10.21105/joss.01434
#> 
