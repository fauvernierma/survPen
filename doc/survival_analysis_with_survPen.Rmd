...
The `survPen` package allows deriving such robust standard errors based on sandwich estimators (Coz et al. submitted to Biostatistics).
...
vec.col <- c("black","forestgreen")

par(mfrow=c(1,2))
plot(nt,pred.MI$MI[pred.MI$treatment==0],type="l",
main="marginal intensity with CIs",
...
lines(nt,pred.MI$MI[pred.MI$treatment==1],lty=2,col=vec.col[2])
...
main="Expected cumulative number of events with CIs",
...
lines(nt,pred.MI$Expected_Nb_event[pred.MI$treatment==1],lty=2,col=vec.col[2])
